...
function vaaKeyArrayToMessageKeyArray(VaaKey[] memory vaaKeys) pure returns (MessageKey[] memory msgKeys) {
...
function encodeMessageKey(MessageKey memory msgKey) pure returns (bytes memory encoded) {
...
function decodeMessageKey(bytes memory encoded, uint256 startOffset)
    pure
    returns (MessageKey memory msgKey, uint256 offset)
{
...
function encodeMessageKeyArray(MessageKey[] memory msgKeys) pure returns (bytes memory encoded) {
...
function decodeMessageKeyArray(bytes memory encoded, uint256 startOffset)
    pure
    returns (MessageKey[] memory msgKeys, uint256 offset)
{
    uint8 msgKeysLength;
...
function decodeCCTPKey(bytes memory encoded, uint256 startOffset)
    pure
    returns (CCTPMessageLib.CCTPKey memory cctpKey, uint256 offset)
{
    offset = startOffset;
...
function decodeDeliveryOverride(bytes memory encoded) pure returns (DeliveryOverride memory strct) {
