...
abstract contract WormholeRelayerTest is Test {
    ...
    string public constant FUJI_URL = "https://api.avax-test.network/ext/bc/C/rpc";
    string public constant CELO_URL = "https://alfajores-forno.celo-testnet.org";
    ...
    IWormholeRelayer public relayerSource = IWormholeRelayer(0xA3cF45939bD6260bcFe3D66bc73d60f19e49a8BB);
    ITokenBridge public tokenBridgeSource = ITokenBridge(0x61E44E506Ca5659E6c0bba9b678586fA2d729756);
    IWormhole public wormholeSource = IWormhole(0x7bbcE28e64B3F8b84d876Ab298393c38ad7aac4C);

    // celo testnet forked contracts
    IWormholeRelayer public relayerTarget = IWormholeRelayer(0x306B68267Deb7c5DfCDa3619E22E9Ca39C374f84);
    ITokenBridge public tokenBridgeTarget = ITokenBridge(0x05ca6037eC51F8b712eD2E6Fa72219FEaE74E153);
    IWormhole public wormholeTarget = IWormhole(0x88505117CA88e7dd2eC6EA1E13f0948db2D50D56);
    ...
    function createAndAttestToken(uint256 fork) public returns (ERC20Mock token) {
        ...
        ITokenBridge tokenBridge = fork == sourceFork ? tokenBridgeSource : tokenBridgeTarget;
        vm.recordLogs();
    ...
    function logFork() public view {
        console.log(vm.activeFork() == sourceFork ? "source fork active" : "target fork active");
    }
